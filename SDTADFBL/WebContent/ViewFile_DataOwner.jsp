...
ArrayList<Bean> al = new ViewDAO().dataOwnerViewFile(fid);
%>
					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
                            ...
                            <div class="media-body tm-service-text">
                                <h2 class="mb-4 tm-content-title"><a href="TransferFileServlet_DataOwner?fid=<%=fid%>">Transfer File</a> / <a href="DeleteFileServlet_DataOwner?fid=<%=fid%>">Delete File</a></h2>
                            </div>
                          <%} %>
												</div>
