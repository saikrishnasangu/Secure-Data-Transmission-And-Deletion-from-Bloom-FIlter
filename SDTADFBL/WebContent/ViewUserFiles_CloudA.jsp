...
<body>
<%
ArrayList<Bean> al = new ViewDAO().cloudAViewUserFiles();
%>
									...
									<%String status = request.getParameter("status");
										...
										<div class="row">
											<div class="col-md-12">
												...
												<th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="./ViewUserFile_cloudA.jsp?fid=<%=b.getFid()%>">View File</a></th>
												</tr>
												<%} %>
												</table>
												</div>
