...
<body>
<%
ArrayList<Bean> al = new ViewDAO().cloudAViewFilesforAccept();
%>
					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								...
								<%if(al.isEmpty()){ %>
								<h3 class="mb-4 heading">New User Files are Not Available</h3>
								<%} %>
								<br>
									...
									<h3 class="mb-4 heading">Users Files
										...
										<div class="row">
											<div class="col-md-12">
												...
												<th style="color: white; font-family: Times New Roman; padding: 20px;">Active</th>
												</tr>
												<%for(Bean b: al){ %>
												<tr>
												...
												<th style="color: white; font-family: Times New Roman; padding: 10px;"><a href="./ActiveNewFilesServlet_CloudA?fid=<%=b.getFid()%>&&uid=<%=b.getUid()%>">Active</a></th>
												</tr>
												<%} %>
												</table>
												</div>
