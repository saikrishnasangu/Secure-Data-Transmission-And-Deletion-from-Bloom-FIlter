						...
						<div class="row d-flex no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4 heading">Cloud B Login</h3>
									<form method="POST" action="./LoginServlet" id="contactForm" name="contactForm" class="contactForm">
										<div class="row">
											<div class="col-md-12"> 
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<%String s = request.getParameter("s");
															if(s!=null)
															{%>
																<h3><font color="green"><%out.print(s); %></font></h3>	
															<%}
													%>
												</div>
