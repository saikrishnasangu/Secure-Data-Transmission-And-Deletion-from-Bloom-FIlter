...
<body>
<%
ArrayList<Bean> al = new ViewDAO().cloudAViewDeleteRequest();
%>
									...
									<h3 class="mb-4 heading">Users Files
										...
										<div class="row">
											<div class="col-md-12">
												...
												<th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="./DeleteRequestToCloudBServlet_CloudA?fid=<%=b.getFid()%>&&uid=<%=b.getUid()%>">Delete Request Send to cloud B</a></th>
												</tr>
												<%} %>
												</table>
												</div>
