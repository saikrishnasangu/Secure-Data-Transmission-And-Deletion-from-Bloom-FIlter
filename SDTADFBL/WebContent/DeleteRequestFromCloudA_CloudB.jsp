...
<body>
<%
ArrayList<Bean> al = new ViewDAO().cloudBViewDeleteRequest();
%>
					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								...
								<%if(al.isEmpty()){ %>
								<h3 class="mb-4 heading">New Delete Requests are Not Available</h3>
								<%} %>
								<br>
								<%String status = request.getParameter("status");
													...
													%>
								<%if(!al.isEmpty()){ %>
									<h3 class="mb-4 heading">Delete Request Files
									</h3>
										<div class="row">
											<div class="col-md-12">
												...
												<th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="./DeleteFileTransferServlet_CloudB?fid=<%=b.getFid()%>&&uid=<%=b.getUid()%>">Accept</a></th>
												</tr>
												<%} %>
												</table>
												</div>
