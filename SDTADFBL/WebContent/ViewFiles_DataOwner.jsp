...
ArrayList<Bean> al = new ViewDAO().doViewFiles(uid);
%>
					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								...
								<%if(al.isEmpty()){ %>
								<h3 class="mb-4 heading">NO Files to Display From Cloud A</h3>
								<%} %>
								<%if(!al.isEmpty()){ %>
									<h3 class="mb-4 heading">Files From Cloud A
									<br>
									<%String status = request.getParameter("status");
										...
										<div class="row">
											<div class="col-md-12">
												...
												<%if(b.getPassword().equals("active")){ %>
												<th style="color: white; font-family: Times New Roman; padding: 20px;"><a href="./ViewFile_DataOwner.jsp?fid=<%=b.getUid()%>">View File</a></th>
												<%}else{ %>
