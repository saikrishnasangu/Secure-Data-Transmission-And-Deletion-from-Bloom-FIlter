...
<body>
<%
ArrayList<Bean> al = new ViewDAO().cloudAViewUsers();
%>
					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
							<div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
								...
								<%if(al.isEmpty()){ %>
								<h3 class="mb-4 heading">NO Users to Display</h3>
								<%} %>
								<%if(!al.isEmpty()){ %>
									<h3 class="mb-4 heading">Users</h3>
										<div class="row">
											<div class="col-md-12">
												...
												<th style="color: white; font-family: Times New Roman; padding: 20px;">UserDateOfBirth</th>
												...
												<th style="color: white; font-family: Times New Roman; padding: 10px;"><%=b.getMobile() %></th>
												<th style="color: white; font-family: Times New Roman; padding: 10px;padding-right: 50px;"><%=b.getDob() %></th>
												<th style="color: white; font-family: Times New Roman; padding: 10px;"><%=b.getAddress() %></th>
												</tr>
												<%} %>
												</table>
												</div>
